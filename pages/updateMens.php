...
// showMem();
$id = $_GET['id'];
$name = returnMensDetails($dbConnect, $id, 'name');
$birth_date = returnMensDetails($dbConnect, $id, 'birth_date');
$nationality = returnMensDetails($dbConnect, $id, 'nationality');
$goals = returnMensDetails($dbConnect, $id, 'goals');
$assists = returnMensDetails($dbConnect, $id, 'assists');
$titles = returnMensDetails($dbConnect, $id, 'titles');
$biography = returnMensDetails($dbConnect, $id, 'biography');
$position = returnMensDetails($dbConnect, $id, 'position');
$image_main = returnMensDetails($dbConnect, $id, 'image_main');
$image_details = returnMensDetails($dbConnect, $id, 'image_details');
$mini_bio = returnMensDetails($dbConnect, $id, 'mini_bio');
...
<body>
    ...
    echo ' <div class="dashboard-controls">
        <div class="form-dash-add">
            <form action="updateMensAction.php" method="post">
                <h4>Update Mens Players</h4>
                <label>Name:</label>
